...
namespace Lab20EFCore.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(MyCoffeeContext context)
        {
            _context = context;
        }
        ...
        //{
        //    var userlogin = await _context.User.FirstOrDefaultAsync(x => x.UserName == user.UserName);

        //    if (user == null)
        //    {
        //        return View("UserUnknown");
        //    }

        //    if(user.Password == userlogin.Password)
        //    {
        //        return View("WelcomeBruh");
        //    }
        //    else
        //    {
        //        return View();
        ...
        public IActionResult UserUnknown()
        {
            return View();
        }
    }
